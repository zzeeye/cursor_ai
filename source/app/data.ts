...
export const skills: Skill[] = [
  ...
  {
    category: "Backend",
    items: ["Spring Framework", "전자정부프레임워크", "Django", "RESTful API", "MyBatis", "iBatis"]
  },
  {
    category: "Frontend",
    items: ["jQuery", "JavaScript", "HTML/CSS", "Bootstrap", "Tailwind CSS"]
  },
  {
    category: "Databases",
  ...
  {
    category: "Others",
    items: ["Google Analytics", "NGINX", "WSL2", "amcharts"]
  }
];
